...
def derived():
    ...
    table("occupancy-table", [r"$r$", "Active probability", "Fold change"],
          [[v["repressor"],f'{v["active"]:.5f}',f'{v["fold"]:.5f}'] for v in r["occupancy"]], "rrr")
    table("identifiability-table", ["Time", r"$m_A$", r"$m_B$", r"$p_A=p_B$", r"$p_C$"],
          [[v["time"],f'{v["rna_a"]:.4f}',f'{v["rna_b"]:.4f}',f'{v["protein_a"]:.4f}',f'{v["protein_c"]:.4f}'] for v in r["alternatives"]], "rrrrr")
    plot("response-plot",r["response"],"time",["rna","protein"])
    plot("identifiability-plot",r["alternatives"],"time",["protein_a","protein_c"])
